...
/**
* @notice CAT-20 transfer verification with rules engine
*/
contract CAT20REVerifyTransfer is CAT20TokenStorage, ICAT20VerifyTransfer {
    /**
    ...
    */
    function verifyTransfer(address from, address to, address sender, uint amount) external {
        ...
        bool allowed = ITransferModule(transferModuleAddress).checkCAT20TransferThroughRE(
            from,
            to,
            sender,
            amount
